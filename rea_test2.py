...
class BaseTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    #self.onto = self.world.get_ontology("/Users/rodrigo/Ont/examples/ex(in)_med.owl").load()
    #self.onto = self.world.get_ontology("/Users/rodrigo/Ont/PizzaTutorial.owl").load()
    #self.onto = self.world.get_ontology("/Users/rodrigo/Ont/obi.owl").load()
    #self.onto = self.world.get_ontology("/Users/rodrigo/Ont/uberon.owl").load()
    #self.onto = self.world.get_ontology("/Users/rodrigo/Ont/go.owl").load()
